export class Constant {
     ...
     */
    static readonly chunkExtensions: readonly string[] = [".ts", ".tsx", ".js", ".jsx", ".less", ".css"];
     ...
     */
    static readonly mainChunkEntryNames: readonly string[] = ["index.tsx", "index.ts", "index.jsx", "index.js", "index.less", "index.css"];
}
