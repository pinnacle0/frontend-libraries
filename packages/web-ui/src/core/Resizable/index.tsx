...
export const Resizable = ReactUtil.memo(
    "Resizable",
    ({initialHeight, initialWidth, x, y, className, style, gap, children, ref, maxHeight = window.innerHeight, maxWidth = window.innerWidth, minHeight = 0, minWidth = 0, ...restProps}: Props) => {
