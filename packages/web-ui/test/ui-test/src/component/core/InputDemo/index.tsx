...
const groups: DemoHelperGroupConfig[] = [
    ...
    },
    {
        ...
        components: [
            <p>no stepper (default)</p>,
            "-",
            <RequiredNumberInput scale={0} editable={false} step={1} initialValue={10} />,
            <RequiredNumberInput scale={0} step={1} initialValue={10} />,
            <RequiredNumberInput scale={1} step={0.2} initialValue={10} />,
            <RequiredNumberInput scale={2} min={0} max={100} step={0.05} initialValue={3.88} />,
            "-",
            <p>outlined</p>,
            "-",
            <RequiredNumberInput scale={0} editable={false} stepperMode="outlined" step={1} initialValue={10} />,
            <RequiredNumberInput scale={0} stepperMode="outlined" step={1} initialValue={10} />,
            <RequiredNumberInput scale={1} stepperMode="outlined" step={0.2} initialValue={10} />,
            <RequiredNumberInput scale={2} min={0} max={100} stepperMode="outlined" step={0.05} initialValue={3.88} />,
            "-",
            <p>no border</p>,
            "-",
            <RequiredNumberInput scale={0} editable={false} stepperMode="no-border" step={1} initialValue={10} />,
            <RequiredNumberInput scale={0} stepperMode="no-border" step={1} initialValue={10} />,
            <RequiredNumberInput scale={1} stepperMode="no-border" step={0.2} initialValue={10} />,
            <RequiredNumberInput scale={2} min={0} max={100} stepperMode="no-border" step={0.05} initialValue={3.88} />,
            "-",
            <p>custom render</p>,
            "-",
            <RequiredNumberInput scale={2} stepperMode="outlined" step={0.05} initialValue={4} displayRenderer={_ => "<" + _ + ">"} />,
            <RequiredNumberInput scale={2} initialValue={4} suffix={<FileSearchOutlined />} />,
            <RequiredNumberInput scale={2} stepperMode="outlined" step={0.05} initialValue={4} suffix="After" />,
        ],
    },
    {
        title: "Nullable Number Input",
        components: [
            <NullableNumberInput scale={0} stepperMode="outlined" />,
    ...
    },
    {
        ...
        components: [<RequiredNumberInputPercentage initialValue={0.4} percentageScale={0} />, <RequiredNumberInputPercentage initialValue={0.6} percentageScale={2} stepperMode="outlined" />],
    },
    {
        title: "Text Area",
